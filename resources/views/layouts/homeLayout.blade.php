...
<body class="main-layout">
                    ...
                    <div class="col-xl-3 col-lg-2 col-md-2 col-sm-3 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo"> <a href="/"><img style="width: 200px !important"
                                        ...
                                        @else
                                            <li class=" nav-item">
                                                <a href="{{ route('cartList') }}"
                                                    class="contact-logo cart-logo nav-link"
                                                    style="width: max-content;"><i class="fas fa-shopping-cart"> (<span
                                                            class="cart-counter">{{ $cart }}</span>) </i> </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="" class="nav-link" style="width: max-content;"><i
                                                        class="fas fa-shopping-bag">(<span>0</span>)</i> </a>
                                            </li>
                                            <!-- <li class="nav-item">
                                 <a href="{{ route('logout') }}" class="nav-link" onclick="event.preventDefault();  document.getElementById('logout-form').submit();">{{ __('Log out') }}</a>
                                            ...
                                            <li class="dropdown nav-item">
                                                <a href="#" class="dropdown-toggle nav-link"
                                                    ...
                                                    <i class="tim-icons icon-single-02"><b
                                                            class="caret d-none d-lg-block d-xl-block"></b></i>
                                                </a>
                                                    ...
                                                    @if (Auth::user()->role == 'admin')
                                                        <li class="nav-link">
                                                            <a href="{{ route('dashboard') }}"
                                                                class="nav-item dropdown-item">{{ __('Dashboard') }}</a>
                                                        </li>
                                                    @endif
    ...
    <nav style="z-index: 99999" id="navbar" class="navbar navbar-expand-custom navbar-mainbg">
        <div class="container">
            <a class="navbar-brand navbar-logo" href="#">Gamers Shop</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item {{ Request::url() == url('/') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('home') }}"><i class="far fa-address-book"></i>Home</a>
                    </li>
                    <li class="nav-item {{ Request::url() == url('/about') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('about') }}"><i class="far fa-address-book"></i>About</a>
                    </li>
                    <li class="nav-item {{ Request::url() == url('/shop') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('shop') }}"><i class="far fa-clone"></i>Shop</a>
                    </li>
                    <li class="nav-item {{ Request::url() == url('/contact') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('contact.index') }}"><i class="far fa-clone"></i>Contact
                            Us</a>
                    </li>
                </ul>
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        <li class=" nav-item">
                            <a href="{{ route('cartList') }}" class="contact-logo cart-logo nav-link"
                                style=""><i class="fas fa-shopping-cart"> (<span
                                        class="cart-counter">{{ $cart }}</span>) </i> </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link" style=""><i
                                    class="fas fa-shopping-bag">(<span>0</span>)</i> </a>
                        </li>
                        <li class="nav-item">
    ...
    <div id="plant" class="footer layout_padding">
        <div class="container">
            <p>© 2022 All Rights Reserved. Design by <a href="https://www.linkedin.com/in/muhamed3li/"
                    target="_blank"> Mohammed Ali </a> & <a href="https://www.linkedin.com/in/ahmed-ashraf-4b7359222/"
                    target="_blank"> Ahmed Ashraf </a> </p>
        </div>
    </div>
